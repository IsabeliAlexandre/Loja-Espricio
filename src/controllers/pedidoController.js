...
const pedidoController = { //objeto javascript, quando abre uma chave e tem o valor
    /**
    ...
    listarPedidos: async (req, res) => {
        try {
            const pedidos = await pedidoModel.buscarTodos(); //é uma função, então tem que ter parênteses
